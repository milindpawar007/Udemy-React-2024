  ...
  return (
    <>
      ...
      <Main>
        ...
        <Box>
          {
            selectedID ? <MovieDeatils selectedID={selectedID} onCloseMovie={handelClosedMovieDetails} onAddWatched={handelWatchedMovie}/>
              :
              <>
...
function MovieDeatils({ selectedID, onCloseMovie ,onAddWatched }) {
